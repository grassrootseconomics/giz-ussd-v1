...
def is_set_pin_guardian(account: Account, checked_number: str,
    ...
    for guardian in set_guardians:
        processed_guardian = process_phone_number(phone_number=guardian, region=E164Format.region, add_plus=False)

    set_guardians.append(processed_guardian)

    is_set_guardian = checked_number in set_guardians or process_phone_number(phone_number=checked_number,
                                                                              region=E164Format.region,
                                                                              add_plus=False) in set_guardians
